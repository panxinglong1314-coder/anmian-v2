...
Page({
  ...
  openAbout() {
    wx.showModal({
      title: '知眠',
      content: '陪你度过睡前的那些脑子停不下来的时刻。\n\n' +
        '基于认知行为失眠疗法（CBT-I）。其睡眠窗口建议参考美国睡眠医学会（AASM）2025 指南及欧洲失眠指南 2023。\n\n' +
        '本应用不提供医疗诊断、治疗或处方，不能替代精神科医生、心理咨询师等专业医疗人士的意见。如存在持续失眠、抑郁焦虑或有自伤念头，请立即就医或拨打心理援助热线。\n\n' +
        '全国心理援助热线 400-161-9995\n' +
